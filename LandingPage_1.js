          ...
          <div className="flex flex-col text-custom-blue space-y-8 w-2/5 p-8 bg-gray-800 shadow-lg ml-4 rounded-lg transition-transform duration-10000 ease-in-out transform hover:scale-105">
            <div className="space-y-4">
              <p className="text-lg font-mono">
               Transform your healthcare experience with our revolutionary blockchain-powered SEHR platform. We combine advanced technologies - secure blockchain storage, rapid-development Ganache framework, seamless Metamask integration, and decentralized IPFS file system - to deliver a new standard in medical record management. Our platform ensures security while making health data instantly accessible and seamlessly shareable across healthcare providers. This innovative approach doesn't just protect your medical information - it helps better clinical decisions and enhances the quality of patient care.
                </p>
            </div>
          </div>
        </div>
